...
public class StatisticServiceIntegrationTest {
    ...
    public void testSetup(){
        ...
        mark1.setStudentsWithMark(studentsWithNdstMarkSet);

        mark2 = new Mark();
        mark2.setMarkName("mrn");
        mark2.setMarkValue(2);
        mark2.setStudentsWithMark(studentsWithMrnMarkSet);

        mark3 = new Mark();
        mark3.setMarkName("dst");
        mark3.setMarkValue(3);
        mark3.setStudentsWithMark(studentsWithDstMarkSet);

        mark4 = new Mark();
        mark4.setMarkName("db");
        mark4.setMarkValue(4);
        mark4.setStudentsWithMark(studentsWithDbMarkSet);

        mark5 = new Mark();
        mark5.setMarkName("bdb");
        mark5.setMarkValue(5);
        mark5.setStudentsWithMark(studentsWithBdbMarkSet);

        mark6 = new Mark();
        mark6.setMarkName("cel");
        mark6.setMarkValue(6);
        mark6.setStudentsWithMark(studentsWithCelMarkSet);
        ...
        student1.setStudentMarks(student1markList);
        ...
        student2.setStudentMarks(student2markList);
        ...
        student3.setStudentMarks(student35markList);
        ...
        student4.setStudentMarks(student4markList);
        ...
        student5.setStudentMarks(student35markList);
        ...
        student6.setStudentMarks(student2markList);
